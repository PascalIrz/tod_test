...
```{r}
url <- "ftp://Admin_Express_ext:Dahnoh0eigheeFok@ftp3.ign.fr/ADMIN-EXPRESS_3-0__SHP__FRA_WM_2021-10-15.7z"
rep <- tempdir()
curl::curl_download(url = url, destfile = "../raw_data/admin_express.7z")
#download.file(url = url, destfile = "raw_data/admin_express", method = "auto")
list.files("../raw_data")
utils::unzip(zipfiles = "../raw_data/admin_express.7z")
system('"C:/Program Files/7-Zip/7z.exe" e -o<"../raw_data"> <"admin_express.7z">')


system('"C:/Program Files/7-Zip/7z.exe" e -aoa -o../raw_data/admin_express.7z ')
