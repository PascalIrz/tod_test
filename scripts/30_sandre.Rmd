...
La fonction `tgeo_wfs_sandre()` du package `tod` permet d'accéder simplement à une masse de "lots de données de référence" disponibles via le flux WFS du Sandre. Pour s'y retrouver, il est utile de se reporter à [cette page](https://www.sandre.eaufrance.fr/actualite/evolution-des-services-web-g%C3%A9ographiques). Ces référentiels géographiques concernent les thèmes suivants :
